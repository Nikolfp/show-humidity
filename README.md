...
> Άνοιγμα αυτής της σελίδας στο [https://nikolfp.github.io/show-humidity/](https://nikolfp.github.io/show-humidity/)
...
* αναζήτηση για **https://github.com/nikolfp/show-humidity** και εισαγωγή
...
* επικολλήστε **https://github.com/nikolfp/show-humidity** και κάντε κλικ στην εισαγωγή
